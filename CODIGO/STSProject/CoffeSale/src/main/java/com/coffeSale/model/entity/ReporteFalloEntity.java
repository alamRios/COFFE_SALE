...
public class ReporteFalloEntity implements Serializable{
	...
	@SequenceGenerator(allocationSize=1, initialValue=1, sequenceName="reporte_fallo_reporte_fallo_id_seq", name="reporte_fallo_reporte_fallo_id_seq")
	@GeneratedValue(generator="reporte_fallo_reporte_fallo_id_seq", strategy=GenerationType.SEQUENCE)
	private int id; 
