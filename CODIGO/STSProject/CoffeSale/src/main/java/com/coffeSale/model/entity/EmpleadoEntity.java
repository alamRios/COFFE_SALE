...
public class EmpleadoEntity implements Serializable{
	...
	@SequenceGenerator(allocationSize=1, initialValue=1, sequenceName="empleado_empleado_id_seq", name="empleado_empleado_id_seq")
	@GeneratedValue(generator="empleado_empleado_id_seq", strategy=GenerationType.SEQUENCE)
	private int id; 
